...
- - EGE320 Embedded System Design &Technology/lab1.md | Lab 1 — CCS IDE setup, project creation/import/export/flashing, sample C program
  ...
  - EGE320 Embedded System Design &Technology/EGE320-Chapter1.md | Chapter 1 — embedded system intro, processors/peripherals, C programming (data types, operators, conditionals, loops, functions)
  - EGE320 Embedded System Design &Technology/week1.md | NEAR-EMPTY — one line stub only, needs content or deletion
...
|----|------|------|-----------|--------|-------|--------|
| A1 | 4-5 | 11-25 May 2026 | Practical 1: ROS bags & packages | 20% | Labs 1-5 | UPCOMING |
| A2 | 6 | 25 May 2026 | Demo Practical 1 | - | Practical 1 | UPCOMING |
| A3 | 7 | 2 Jun 2026 | Proctored Quiz-1 | 10% | Labs 1-6, Ch 1-2 | UPCOMING |
