...
int32_t GrStringWidthGet(const tContext *pContext, const char *pcString,
                 	 	 int32_t i32Length)
{
...
#else
int32_t
GrStringWidthGet(const tContext *pContext, const char *pcString, int32_t i32Length)
{
    const uint8_t *pui8Data;
...
//
void GrStringDraw(const tContext *pContext, const char *pcString, int32_t i32Length,
...
//!
//*****************************************************************************
uint32_t GrStringNextCharGet(const tContext *pContext, const char *pcString,
...
//! \return None.
//*****************************************************************************
void GrFontGlyphRender(const tContext *pContext, const uint8_t *pui8Data,
...
//! \return None.
//*****************************************************************************
void GrFontInfoGet(const tFont *psFont, uint8_t *pui8Format, uint8_t *pui8MaxWidth,
...
//*****************************************************************************
uint32_t GrFontBaselineGet(const tFont *psFont)
{
...
//*****************************************************************************
uint32_t GrFontHeightGet(const tFont *psFont)
{
    uint8_t ui8Format, ui8Width, ui8Height, ui8Baseline;
...
//*****************************************************************************
uint32_t GrFontMaxWidthGet(const tFont *psFont)
{
    uint8_t ui8Format, ui8Width, ui8Height, ui8Baseline;
...
//*****************************************************************************
static const uint8_t *FontGlyphDataGet(const tFont *psFont, uint32_t ui32CodePoint,
                                       uint8_t *pui8Width)
{
    const uint8_t *pui8Glyphs;
    const uint16_t *pui16Offset;
...
// the glyph does not exist in the font.
//*****************************************************************************
static const uint8_t *FontWideGlyphDataGet(const tFontWide *psFont, uint32_t ui32CodePoint,
                                           uint8_t *pui8Width)
{
    const uint8_t *pui8Data;
    tFontBlock *pBlock;
...
//! the glyph does not exist in the font.
//*****************************************************************************
const uint8_t *GrFontGlyphDataGet(const tFont *psFont, uint32_t ui32CodePoint,
                                  uint8_t *pui8Width)
{
...
//*****************************************************************************
uint16_t GrFontCodepageGet(const tFont *psFont)
{
...
//*****************************************************************************
static int32_t UpdateContextCharMapping(tContext *pContext)
{
    uint32_t ui32Loop;
...
//*****************************************************************************
uint16_t GrFontNumBlocksGet(const tFont *psFont)
{
    // Is this a wide character set font?
    //
    if(psFont->ui8Format & FONT_WIDE_MARKER)
...
//*****************************************************************************
uint32_t GrFontBlockCodepointsGet(const tFont *psFont, uint16_t ui16BlockIndex,
                                  uint32_t *pui32Start)
{
    // Is this a wide character set font?
    //
...
//! \return None.
//*****************************************************************************
void GrCodepageMapTableSet(tContext *pContext, tCodePointMap *pCodePointMapTable,
                           uint8_t ui8NumMaps)
{
...
//! \return None.
//*****************************************************************************
int32_t GrStringCodepageSet(tContext *pContext, uint16_t ui16Codepage)
{
...
//! \return None.
//*****************************************************************************
void GrContextFontSet(tContext *pContext, const tFont *psFont)
{
