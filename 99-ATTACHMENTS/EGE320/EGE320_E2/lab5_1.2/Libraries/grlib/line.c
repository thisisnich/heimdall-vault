...
//! \return None.
//*****************************************************************************
void GrLineDrawH(const tContext *pContext, int32_t i32X1, int32_t i32X2, int32_t i32Y)
{
    int32_t i32Temp;
    ...
    //
    DpyLineDrawH(pContext->psDisplay, i32X1, i32X2, i32Y, pContext->ui32Foreground);
}
...
//! \return None.
//*****************************************************************************
void GrLineDrawV(const tContext *pContext, int32_t i32X, int32_t i32Y1, int32_t i32Y2)
{
    int32_t i32Temp;
    ...
    //
    DpyLineDrawV(pContext->psDisplay, i32X, i32Y1, i32Y2, pContext->ui32Foreground);
}
...
//*****************************************************************************
static int32_t GrClipCodeGet(const tContext *pContext, int32_t i32X, int32_t i32Y)
{
    int32_t i32Code;
...
//*****************************************************************************
static int32_t GrLineClip(const tContext *pContext, int32_t *pi32X1, int32_t *pi32Y1,
...
//! \return None.
//*****************************************************************************
void GrLineDraw(const tContext *pContext, int32_t i32X1, int32_t i32Y1,
