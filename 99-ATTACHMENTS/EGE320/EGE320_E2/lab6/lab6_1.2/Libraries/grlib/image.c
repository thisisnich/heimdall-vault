...
//*****************************************************************************
static bool PixelTransparentDraw(const tContext *pContext, int32_t i32X, int32_t i32Y,
...
//*****************************************************************************
static void InternalImageDraw(const tContext *pContext, const uint8_t *pui8Image,
