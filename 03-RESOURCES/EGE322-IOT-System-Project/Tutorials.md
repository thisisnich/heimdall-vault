...
```mermaid
graph TD
    A["Project"] --> B["Temporary Endeavor"]
    A --> C["Unique Product/Service/Result"]
    A --> D["Defined Start & End"]
    A --> E["Specific Objectives"]
    A --> F["Requires Resources"]
...
```mermaid
graph TD
    A["Effort<br/>Total work required<br/>(person-hours)"] -->|"÷ Resources"| B["Duration<br/>Time needed<br/>to complete task"]
    B -->|"× Resource Availability"| C["Calendar Time<br/>Actual elapsed time<br/>including delays"]
