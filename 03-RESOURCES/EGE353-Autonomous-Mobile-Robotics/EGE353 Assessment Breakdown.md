...
| 15-17 | **Project (Part A):** Robot design project<br>**Project (Part B):** SLAM implementation for path planning, navigation, and obstacle avoidance using real mobile robots | 35% |
| | **Total** | **100%** |
