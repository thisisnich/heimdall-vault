...
topic: Lab 4 - Combination Logic 2
source: 23S2 EGE351 Lab 4 - Automation .pdf
...
EXPERIMENT TITLE:  Combination Logic 2
...
### Question 2
A PLC is used to control a traffic light system. Write a program to simulate the traffic light. When a START (NO) pushbutton is pressed, the following steps are executed:
